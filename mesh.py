...
'''
Class to generate the spectral element grid.
'''
...
class sem_grid:
    ...
    def __init__(self):
        ...
        self.n_elem         = 100                                       # Number of elements
        self.rho_c          = 3300.0                                    # density (kg/m3)
        ...
        #self.elem     = np.linspace(0,self.length,self.n_elem)    # Elements
